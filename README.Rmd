...
```{r, eval=TRUE, fig.height = 3.5, fig.show='hide', echo = FALSE}
library(tmap)
library(tmap.mapgl)
...
if (is_html_output()) {
	...
	m  = print(tm, show = FALSE)
	if (requireNamespace("mapview", quietly = TRUE)) {
		if (!dir.exists("man/figures")) dir.create("man/figures", recursive = TRUE)
		mapview::mapshot2(m, file = "man/figures/README-map.png", vwidth = 1600, vheight = 1200, )
	}
	knitr::include_graphics("man/figures/README-map.png")
}
```
