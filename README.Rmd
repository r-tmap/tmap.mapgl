...
[tmap](https://r-tmap.github.io/tmap/) is a R package for visualizing spatial data. This package, **tmap.mapgl** is an extension which features two new modes: `"mapbox"` and `"maplibre"`.
